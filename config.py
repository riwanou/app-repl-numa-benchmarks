...
RESULT_DIR_LOCALITY = os.path.join(RESULT_DIR, PLATFORM, "locality")
...
RESULT_DIR_PGTABLE_SYNC = os.path.join(RESULT_DIR_MICROBENCH, "pgtable_sync")
...
PLOT_DIR_PRESSURE_DETAILS = os.path.join(PLOT_DIR_PRESSURE, "details")
PLOT_DIR_MICROBENCH = os.path.join(PLOT_DIR, "microbench")
PLOT_DIR_PGTABLE_SYNC = os.path.join(PLOT_DIR_MICROBENCH, "pgtable_sync")
